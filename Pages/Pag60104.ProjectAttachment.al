page 60104 "Xee Project Attachment"
{
    PageType = List;
    UsageCategory = Lists;
    ApplicationArea = All;
    ...
    var
        Recs: Record "Xee Project Header"; //Change the Table Name Here----OLISTER
    ...
    procedure SaveAttachment2(RecRef: RecordRef; FileName: Text; TempBlob: Codeunit "Temp Blob"; PaymentRequestAttachment: Boolean; PaymentRequestNo: Code[30])
    var
